class CLI 
    ...
    def print_choice(book)
        ...
        puts ""
        puts "Author: #{book.author[0]}".blue if book.author != nil 
        puts ""
        puts "ISBN: #{book.isbn[0]}".blue if book.isbn != nil 
        puts ""
        puts "Year published: #{book.publish_year[0]}".blue if book.publish_year != nil 
        puts ""
        puts "Subject: #{book.subject}".blue if book.subject != nil 
        puts ""
    end 
